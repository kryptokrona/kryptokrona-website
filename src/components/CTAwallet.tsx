    ...
    <HStack py="20" verticalAlign="top">
      <VStack align="start" spacing="8">
        ...
        <HStack>
          <VscDebugStart />
          <Text as="em">
            The wallet stores your private key so you can easily send and
            receive Kryptokrona.
          </Text>
        </HStack>
        <HStack>
          <VscDebugStart />
          <Text as="em">
            If you don’t have access to a computer you can create a paper
            wallet.
          </Text>
        </HStack>
      </VStack>
      <VStack direction="row">
        <Img
          maxW="lg"
          src="https://user-images.githubusercontent.com/3246908/125691331-a40a038f-c12e-4c37-9e96-de5b371bb103.png"
        />
      </VStack>
    </HStack>
  );
